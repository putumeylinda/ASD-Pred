...
Original file is located at
    https://colab.research.google.com/drive/1bfqebDBc37qgFSlwzIfABXltr2fjgRJd
"""
...
def main():
    ...
    # --- Halaman 3: Hasil Prediksi ---
        ...
        df_chart = pd.DataFrame(prediction_proba, index=display_classes, columns=["Probabilitas"])

        # Transpose DataFrame (.T) agar label "Iya" / "Tidak" menjadi horizontal (sumbu X)
