...
Original file is located at
    https://colab.research.google.com/drive/1FGkt_ALjKH_ocBSr2g73W8AG95FaNUfR
"""
...
def main():
    ...
    # --- Halaman 3: Hasil Prediksi ---
        ...
        # --- PERUBAHAN: Mengganti st.bar_chart dengan st.altair_chart ---
        ...
        chart = alt.Chart(df_chart).mark_bar().encode(
            # Sumbu X sebagai probabilitas (diformat persen)
            x=alt.X('Probabilitas:Q', title='Probabilitas', axis=alt.Axis(format='%')),
            # Sumbu Y sebagai "Iya"/"Tidak" (label horizontal otomatis)
            y=alt.Y('Hasil:N', title='Prediksi', sort=None),
            # Beri warna berbeda
            color=alt.Color('Hasil:N', legend=None)
        ).properties(
