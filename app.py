...
Original file is located at
    https://colab.research.google.com/drive/1vL6YMdpKMsmyzTMDSt_3IKO2FzOu7rhX
"""
...
def main():
    ...
    # --- Halaman 3: Hasil Prediksi ---
        ...
        # --- PERBAIKAN GRAFIK BAR ---
        # Membuat DataFrame dengan urutan yang diinginkan: 'Iya' di atas 'Tidak'
        # Dataframe harus disusun agar 'Iya' (kemungkinan ASD) berada di atas untuk tampilan yang lebih logis
        chart_data = pd.DataFrame({
            "Probabilitas": [proba_yes, proba_no] # Urutan: [Iya, Tidak]
        }, index=["Iya (ASD)", "Tidak (Non-ASD)"])

        st.subheader("Probabilitas Hasil Prediksi")
        # Bar chart akan menampilkan indeks pertama di bagian bawah
